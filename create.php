...
$sql = "INSERT INTO gadgets (model,price,Phone,description,photosource,numb,brands) VALUES ('$model','$price','$phone','$description','$filepath','$numb','$brand')";
...
?>
 <!-- Top header -->
  <header class="w3-container w3-xxxlarge">
    <p class="w3-center">Laptop Store | Sell Your Product</p>
  </header><br><br><br><br>
