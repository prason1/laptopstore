...
<head>
    ...
    <style type="text/css">
        body{ font: 14px sans-serif; background-color: white ;align-content: center;}
    ...
    <div class="wrapper">
        ...
        <p>Please fill in your credentials to login.</p>
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Name</label>
                <input type="text" name="admin_name" class="form-control" value="<?php echo $username; ?>" placeholder="Name...">
