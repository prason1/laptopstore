...
$id = $_POST['product_ID'];
$sql = "UPDATE gadgets SET model ='$item',price = '$price',Phone = '$phone',description = '$description',photosource = '$filepath', brands = '$brand' WHERE product_ID = '$id' ";
...
<div class="page-header">
        <h1 align="center"><b>LaptopBazaar | Update Products</b></h1>
    </div>
<div class="topnav">
  <a href="boredsumo.php"><b>Home</b></a>
  <a href="createa.php">Sell Your Product</a>
